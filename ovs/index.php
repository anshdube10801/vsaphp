...
<head>
    ...
    <!-- Webpage Title -->
    <title>Log In - Online voting System</title>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light"style="background-color:white;">
        <div class="container">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                ...
                <span class="nav-item">
                    <a class="btn-solid-sm page-scroll" href="routes/register.php">sign-up</a>
                </span>
            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3">
                    <div class="text-box mt-5 mb-5">
                        <p class="mb-4">You don't have a password? Then please <a class="blue" href="routes/register.php">Sign Up</a></p>
